...
res<-glmer(GotSticker ~ z.age + z.trial + z.age:z.trial + (1+z.trial|ID), data=Cyl.validtrials, family=binomial)

null <- glmer(GotSticker ~ 1 + (1+z.trial|ID), data=Cyl.validtrials, family=binomial)
...
```{r}
res.nointer<-glmer(GotSticker ~ z.age + z.trial + (1+z.trial|ID), data=Cyl.validtrials, family=binomial)
...
```{r}
res<-glmer(GotSticker ~ z.age + z.trial + (1+z.trial|ID), data=Cyl.validtrials, family=binomial)
...
```{r}
res.notrial<-glmer(GotSticker ~ z.age + (1+z.trial|ID), data=Cyl.validtrials, family=binomial)
...
**Effect of age**
```{r}
res.noage<-glmer(GotSticker ~ z.trial + (1+z.trial|ID), data=Cyl.validtrials, family=binomial)
