...
# CD: All children who started that phase, independent of whether or not they reached criterion in SD (this will not be used for the actual analysis, is here jst for sake of completion)
## How many children started the task?
```{r}
